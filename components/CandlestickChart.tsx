...
const CandlestickChart = ({
  ...
  const fetchOHLCData = async (selectedPeriod: Period) => {
    try {
      ...
      logError('Failed to fetch OHLC data for chart', e, { coinId, period: selectedPeriod });
    }
  };
    ...
    <div id="candlestick-chart">
      <div className="chart-header">
        ...
        <div className="button-group">
          <span className="text-sm mx-2 font-medium text-gray-400/50">Period:</span>
        ...
        {liveInterval && (
          <div className="button-group">
            <span className="text-sm mx-2 font-medium text-gray-400/50">Update Frequency:</span>
